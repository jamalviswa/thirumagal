...
function dropdownChange()   
  {
    var pur=document.getElementById("purchase_type").value;
    var gen=document.getElementById("gender").value;
    if(pur=="purchase" && gen=="female")    
    {
      $("#female_condition").show();
    }
   
    else{
      $("#female_condition").hide(); 
    }
...
$('.female').on('change', function () {
  ...
  {
    $("#exp_delivery_date").show(); 
    $("#mating_date").hide();
  } 
  else if(this.value == 'mated') {
      $("#mating_date").show();
      $("#exp_delivery_date").hide(); 
  }
  else{
    $("#exp_delivery_date").hide(); 
    $("#mating_date").hide();
